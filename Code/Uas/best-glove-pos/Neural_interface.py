...
from Neural_model import train_single, train_update, class_Size, edu_padding_length
...
def NetUpdate(conflist, t_os):
    ...
    for conf in conflist:
        ...
        A_vector_list = get_action_vector_list(conf.action_stack, 3)
        A_vector_lists.append(A_vector_list)
    gold_action = [[1 if i == t_o else 0 for i in range(class_Size)] for t_o in t_os]
